...
CUBE = array_utils.c images.c map_parsing.c moves.c draw.c ray.c textures.c keyboard.c player.c checkers.c t_tex_utils.c tc_utils.c fetch_header_data.c main.c
